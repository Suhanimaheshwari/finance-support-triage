...
export default function StatCard({ label, value, icon: Icon, color = 'green', delta, loading }) {
  ...
  <motion.div
    ...
    className="bg-[#1e293b] p-5 rounded-2xl shadow-lg border border-gray-700 hover:scale-105 transition"
  >
    <div className="flex items-start justify-between">
      <div>
        ...
        {delta !== undefined && (
          <p className={`text-xs mt-1 font-medium ${delta >= 0 ? 'text-green-400' : 'text-red-400'}`}>
